...
function dockerCM(pProcess, callback) { // inspired by http://yahooeng.tumblr.com/post/75054690857/code-coverage-for-executable-node-js-scripts
  ...
  var dockerOptions = parseArgs(pProcess.argv.slice(2), {
    stopEarly: true
  })
  ...
  if (!dockerOptions._ || dockerOptions._.length < 2) {
    ...
    if (typeof commandFunction !== 'function') {
      ...
      var descriptionOptions = parseArgs(dockerOptions._.slice(1), {
        stopEarly: true
      })
      ...
      if (!descriptionTarget) {
        ...
        var commandOptions = parseArgs(descriptionOptions._.slice(1), {
          stopEarly: true
        })
        ...
        commandFunction.call(dockerCmdManager, descriptionTarget, descriptionOptions, commandOptions, dockerOptions, function (dockerProcessExitError) {
          return callback(dockerProcessExitError)
        })
      }
    }
  }
